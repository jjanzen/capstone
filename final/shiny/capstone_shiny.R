...
getwd()
#setwd("~/JHDataScience/data_products/data_products_cp")
list.dirs()

install.packages("shiny")
install.packages('devtools')
devtools::install_github('rstudio/shinyapps')
shinyapps::setAccountInfo(name='jjanzen', token='xxxxxx', secret='xxxxxx')
library(shinyapps)
library(ggplot2)
...
# url https://jjanzen.shinyapps.io/shiny
